...
import interactivenamepopper 
from sklearn.linear_model import LinearRegression
reload(interactivenamepopper)
...
class TwoVariableComparisonPlotter(object):
    ...
    def set_interactive_proximity(self):
        ...
        if self.interaction_proximity_x is None:
            self.interaction_proximity_x = (xmax-xmin)/100.
        if self.interaction_proximity_y is None:
            self.interaction_proximity_y = (ymax-ymin)/100.
    ...
    def put_point_labels(self):
        ...
        for name, xi, yi in zip(self.names, self.x, self.y):
            ...
            if self.label_display_style == "showall":
                ...
                popper = interactivenamepopper.NamePopperOnClick(self.fig, label_location, 
                                           name, color='black',
                ...
                popper = interactivenamepopper.NamePopperOnHover(self.fig, label_location, 
